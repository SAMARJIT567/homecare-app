...
class PolicyholdersScreen extends StatefulWidget {
  const PolicyholdersScreen({super.key});
...
class _PolicyholdersScreenState extends State<PolicyholdersScreen> {
  ...
  void _showAddEditBottomSheet({Policyholder? policyholder}) {
    ...
    final nameController = TextEditingController(text: policyholder?.name ?? '');
    final policyNumberController = TextEditingController(text: policyholder?.policyNumber ?? '');
    final phoneController = TextEditingController(text: policyholder?.phone ?? '');
    final addressController = TextEditingController(text: policyholder?.address ?? '');
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Colors.blue.shade400, // ✅ Same as Caregivers
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors.blue.shade50, // ✅ Same as Caregivers
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Row(
                                children: [
                                  const Icon(
                                    Icons.phone,
                                    size: 12,
                                    color: Colors.blue, // ✅ Same as Caregivers
                                  ),
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () =>
                              _showAddEditBottomSheet(policyholder: policyholder),
                          tooltip: 'Edit',
                        ),
                        IconButton(
                          icon: const Icon(
